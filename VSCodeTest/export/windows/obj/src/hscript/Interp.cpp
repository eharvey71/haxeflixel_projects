...
HXLINE( 146)				v = this->set(this->expr(e),f,v);
            			...
            			break;
            			case (int)16: {
HXLINE( 147)				 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 154)						arr->__SetItem(( (int)(index1) ),v);
            			...
            			break;
            			default:{
HXLINE( 158)				 ::hscript::Error e = ::hscript::Error_obj::EInvalidOp(HX_("=",3d,00,00,00));
...
HXLINE( 181)					v = this->set(obj,f,v);
            			...
            			break;
            			case (int)16: {
HXLINE( 182)				 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 191)						arr->__SetItem(( (int)(index1) ),v);
            			...
            			break;
            			default:{
HXLINE( 194)				 ::hscript::Error e = ::hscript::Error_obj::EInvalidOp(op);
...
HXLINE( 222)				return v;
            			...
            			break;
            			case (int)16: {
HXLINE( 223)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 223)				 ::hscript::Expr index = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 224)				 ::Dynamic arr = this->expr(e1);
...
HXDLIN( 247)				 ::hscript::Error e1 = ::hscript::Error_obj::EInvalidOp(e);
...
HXLINE( 264)			return this->expr(e);
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE( 265)				 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXDLIN( 298)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            		}
            		else {
HXDLIN( 298)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            		}
...
HXLINE( 340)				return null();
            			...
            			break;
            			case (int)3: {
HXLINE( 341)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 342)				return this->expr(e1);
            			}
            			break;
            			case (int)4: {
...
HXLINE( 346)						 ::hscript::Expr e = exprs->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 346)						_g = (_g + 1);
...
HXLINE( 349)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 350)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 350)				::String f = e->_hx_getString(1);
HXLINE( 351)				return this->get(this->expr(e1),f);
            			}
            			break;
            			case (int)6: {
HXLINE( 352)				::String op = e->_hx_getString(0);
HXDLIN( 352)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 352)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 353)				 ::Dynamic fop = this->binops->get(op);
HXLINE( 354)				if (::hx::IsNull( fop )) {
HXLINE( 354)					 ::hscript::Error e = ::hscript::Error_obj::EInvalidOp(op);
HXDLIN( 354)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            				}
HXLINE( 355)				return fop(e1,e2);
            			}
            			break;
            			case (int)7: {
HXLINE( 356)				::String op = e->_hx_getString(0);
HXDLIN( 356)				bool prefix = e->_hx_getBool(1);
HXDLIN( 356)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 357)				::String _hx_switch_0 = op;
            				if (  (_hx_switch_0==HX_("!",21,00,00,00)) ){
HXLINE( 359)					return ::hx::IsNotEq( this->expr(e1),true );
HXDLIN( 359)					goto _hx_goto_52;
            				}
            				if (  (_hx_switch_0==HX_("++",a0,25,00,00)) ){
HXLINE( 363)					return this->increment(e1,prefix,1);
HXDLIN( 363)					goto _hx_goto_52;
            				}
            				if (  (_hx_switch_0==HX_("-",2d,00,00,00)) ){
HXLINE( 361)					return -(this->expr(e1));
HXDLIN( 361)					goto _hx_goto_52;
            				}
            				if (  (_hx_switch_0==HX_("--",60,27,00,00)) ){
HXLINE( 365)					return this->increment(e1,prefix,-1);
HXDLIN( 365)					goto _hx_goto_52;
            				}
            				if (  (_hx_switch_0==HX_("~",7e,00,00,00)) ){
HXLINE( 370)					return ~(( (int)(this->expr(e1)) ));
HXDLIN( 370)					goto _hx_goto_52;
            				}
            				/* default */{
HXLINE( 373)					 ::hscript::Error e = ::hscript::Error_obj::EInvalidOp(op);
HXDLIN( 373)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            			...
            			break;
            			case (int)8: {
HXLINE( 375)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 377)						 ::hscript::Expr p = params->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 377)						_g = (_g + 1);
HXLINE( 378)						args->push(this->expr(p));
            					}
            				}
HXLINE( 380)				if ((e1->_hx_getIndex() == 5)) {
HXLINE( 381)					 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 381)					::String f = e1->_hx_getString(1);
HXLINE( 382)					 ::Dynamic obj = this->expr(e);
HXLINE( 383)					if (::hx::IsNull( obj )) {
HXLINE( 383)						 ::hscript::Error e = ::hscript::Error_obj::EInvalidAccess(f);
HXDLIN( 383)						HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            					}
HXLINE( 384)					return this->fcall(obj,f,args);
            				}
            				else {
HXLINE( 386)					return this->call(null(),this->expr(e1),args);
            				}
            			}
            			break;
            			case (int)9: {
...
HXDLIN( 388)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 389)				if (::hx::IsEq( this->expr(econd),true )) {
HXLINE( 389)					return this->expr(e1);
            				}
            				else {
...
HXLINE( 389)						return this->expr(e2);
            			...
            			break;
            			case (int)10: {
HXLINE( 390)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 390)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 391)				this->whileLoop(econd,e1);
HXLINE( 392)				return null();
            			}
            			break;
            			case (int)11: {
HXLINE( 396)				::String v = e->_hx_getString(0);
HXDLIN( 396)				 ::hscript::Expr it = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 396)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 397)				this->forLoop(v,it,e1);
...
HXLINE( 446)							r = me->exprReturn(fexpr);
            							...
            							if (_hx_e.IsClass<  ::Dynamic >() ){
            								HX_STACK_BEGIN_CATCH
            								 ::Dynamic _g = _hx_e;
HXLINE( 447)								 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE( 406)				 ::hscript::CType _g = e->_hx_getObject(3).StaticCast<  ::hscript::CType >();
HXDLIN( 406)				::Array< ::Dynamic> params = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE( 476)				return f1;
            			...
            			break;
            			case (int)15: {
HXLINE( 403)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 404)				 ::Dynamic _hx_tmp;
HXDLIN( 404)				if (::hx::IsNull( e1 )) {
HXLINE( 404)					_hx_tmp = null();
            				}
            				else {
HXLINE( 404)					_hx_tmp = this->expr(e1);
            				}
...
HXLINE( 405)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::_Interp::Stop_obj::SReturn_dyn()));
            			...
            			break;
            			case (int)16: {
HXLINE( 519)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 519)				 ::hscript::Expr index = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 520)				 ::Dynamic arr = this->expr(e1);
...
HXLINE( 526)					return arr->__GetItem(( (int)(index1) ));
            			...
            			break;
            			case (int)17: {
HXLINE( 477)				::Array< ::Dynamic> arr = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 478)				bool _hx_tmp;
HXDLIN( 478)				if ((arr->length > 0)) {
HXLINE( 478)					 ::hscript::Expr _g = arr->__get(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 478)					if ((_g->_hx_getIndex() == 6)) {
HXLINE( 478)						 ::hscript::Expr _g1 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 478)						 ::hscript::Expr _g2 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 485)							 ::hscript::Expr e = arr->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 485)							_g = (_g + 1);
HXLINE( 486)							if ((e->_hx_getIndex() == 6)) {
HXLINE( 487)								if ((e->_hx_getString(0) == HX_("=>",61,35,00,00))) {
HXLINE( 487)									 ::hscript::Expr eKey = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 487)									 ::hscript::Expr eValue = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 487)									{
...
HXLINE( 514)							 ::hscript::Expr e = arr->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 514)							_g = (_g + 1);
...
HXDLIN( 528)				::Array< ::Dynamic> params = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 529)				::cpp::VirtualArray a = ::cpp::VirtualArray_obj::__new();
HXLINE( 530)				{
HXLINE( 530)					int _g = 0;
HXDLIN( 530)					while((_g < params->length)){
HXLINE( 530)						 ::hscript::Expr e = params->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 530)						_g = (_g + 1);
...
HXLINE( 532)				return this->cnew(cl,a);
            			...
            			break;
            			case (int)19: {
HXLINE( 533)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 534)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(this->expr(e1)));
            			}
            			break;
            			case (int)20: {
HXLINE( 535)				 ::hscript::CType _g = e->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN( 535)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 535)				::String n = e->_hx_getString(1);
...
HXLINE( 540)					 ::Dynamic v = this->expr(e1);
...
HXLINE( 543)					return v;
            					...
            					if (_hx_e.IsClass<  ::Dynamic >() ){
            						HX_STACK_BEGIN_CATCH
            						 ::Dynamic _g = _hx_e;
HXLINE( 544)						 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE( 562)				return o;
            			...
            			break;
            			case (int)22: {
HXLINE( 563)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 563)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 563)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 564)				if (::hx::IsEq( this->expr(econd),true )) {
HXLINE( 564)					return this->expr(e1);
            				}
            				else {
HXLINE( 564)					return this->expr(e2);
            			...
            			break;
            			case (int)23: {
HXLINE( 565)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 566)				 ::Dynamic val = this->expr(e1);
...
HXLINE( 569)								 ::hscript::Expr v = _g2->__get(_g1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 581)				return val;
            			...
            			break;
            			case (int)24: {
HXLINE( 393)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 393)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 394)				this->doWhileLoop(econd,e1);
HXLINE( 395)				return null();
            			}
            			break;
            			case (int)25: {
HXLINE( 582)				::String _g = e->_hx_getString(0);
HXDLIN( 582)				::Array< ::Dynamic> _g1 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 582)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 583)				return this->expr(e1);
            			}
            			break;
            			case (int)26: {
HXLINE( 584)				 ::hscript::CType _g = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 584)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 585)				return this->expr(e1);
            			}
            			break;
            		}
...
HXLINE( 594)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE( 595)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE( 611)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE( 612)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE( 640)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE( 641)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
